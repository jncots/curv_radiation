...
!=================================================
   ...
   subroutine study_curv_losses
      ...
      integer :: i, j
      real(8) :: gammaa(5), rcross(7)

      gammaa = [1d6, 3d6, 1d7, 3d7, 1d8]
      rcross = [1d-2, 3d-2, 1d-1, 3d-1, 5d-1, 8d-1, 1d0]
      file_ind = 0

      do i = 1, ng
         do j = 1, nr
            file_ind = file_ind + 1
            call calc_syst(gammaa(i), rcross(j))
         end do
      end do
   ...
   subroutine calc_syst(gamma, rcross)
      real(8), intent(in) :: gamma, rcross
